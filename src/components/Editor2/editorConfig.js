...
module.exports = (config) => {
  return {
    allowedContent: 'p{margin,font-weight,font-size,line-height,font-familyadding,border-width,border-top-style,border-bottom-style,border-top-color,border-bottom-color,text-align,color,font-style}; b i blockquote ol ul li; a[!href,target]; img[!src,alt,width]{vertical-align,margin,float}',
